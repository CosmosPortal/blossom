...
export default async function (interaction: MessageComponentInteraction, client: Client<true>, handler: CommandKit): Promise<undefined> {
    ...
    for (const value of interaction.values) {
        ...
        const current_value = moderation_setting[value as keyof ModerationSetting] ?? false;

        await UpdateEntity(ModerationSetting, { Snowflake: interaction.guild.id }, { [value]: !current_value });
    };
