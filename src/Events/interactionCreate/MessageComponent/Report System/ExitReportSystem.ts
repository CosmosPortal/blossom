...
import { ActionTypeName, Blossom, FindOneEntity, ReportSystem, Sentry, UpdateEntity, type ReportType } from "../../../../Core";
...
export default async function (interaction: MessageComponentInteraction, client: Client<true>, handler: CommandKit): Promise<undefined> {
    ...
    return void await interaction.followUp({ content: `The ${ActionTypeName[report_system.Type as ReportType].toLowerCase()} was closed in **${interaction.guild.name}**!`, ephemeral: true });
};