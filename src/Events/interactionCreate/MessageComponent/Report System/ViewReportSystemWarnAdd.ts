...
export default async function (interaction: MessageComponentInteraction, client: Client<true>, handler: CommandKit): Promise<undefined> {
    if (!interaction.inCachedGuild() || !interaction.isButton() || interaction.customId !== "ViewReportSystemWarnAdd") return;
    ...
    const modal_response = new ModalBuilder({
        custom_id: "TriggerReportSystemWarnAdd",
        title: "Report System | Warn Add"
    })
    .CreateTextInput({
        custom_id: "reason",
