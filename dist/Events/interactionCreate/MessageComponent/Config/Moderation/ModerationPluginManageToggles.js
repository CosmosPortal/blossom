...
// src/Events/interactionCreate/MessageComponent/Config/Moderation/ModerationPluginManageToggles.ts
var ModerationPluginManageToggles_exports = {};
__export(ModerationPluginManageToggles_exports, {
  default: () => ModerationPluginManageToggles_default
});
module.exports = __toCommonJS(ModerationPluginManageToggles_exports);
...
// src/Events/interactionCreate/MessageComponent/Config/Moderation/ModerationPluginManageToggles.ts
async function ModerationPluginManageToggles_default(interaction, client, handler) {
  if (!interaction.inCachedGuild() || !interaction.isStringSelectMenu() || interaction.customId !== "ModerationPluginManageToggles") return;
  ...
  await UpdateTogglePlugin(GuildModerationSetting, {
...
__name(ModerationPluginManageToggles_default, "default");
